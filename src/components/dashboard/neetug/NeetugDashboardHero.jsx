...
// Per-card period data, mirroring the NEET PG dashboard pattern
const ALLOTMENTS_PERIODS = [
  {
    id: "2025",
    label: "Year",
    value: "2025",
    link: "/dashboard/neetug-allotments-2025",
  },
  // {
  //   id: "2024",
  //   label: "Year",
  //   value: "2024",
  //   link: "/dashboard/neetug-allotments-2024",
  // },
];
...
const CLOSING_RANKS_PERIODS = [
  {
    ...
    label: "Year",
    value: "2025",
    link: "/dashboard/neetug-closing-ranks-2025",
  },
  // {
  //   id: "2024",
  //   label: "Year",
  //   value: "2024",
  //   link: "/dashboard/neetug-closing-ranks-2024",
  // },
];
...
const SEAT_MATRIX_PERIODS = [
  {
    ...
    label: "Year",
    value: "2025",
    link: "/dashboard/neetug-seat-matrix-2025",
  },
  // {
  //   id: "2024",
  //   label: "Year",
  //   value: "2024",
  //   link: "/dashboard/neetug-seat-matrix-2024",
  // },
];
...
const FEE_STIPEND_BOND_PERIODS = [
  {
    ...
    label: "Year",
    value: "2025",
    link: "/dashboard/neetug-fee-stipend-bond-2025",
  },
  // {
  //   id: "2024",
  //   label: "Year",
  //   value: "2024",
  //   link: "/dashboard/neetug-fee-stipend-bond-2024",
  // },
];
      ...
      {activeCard && (
        ...
        >
          ...
          >
            ...
            <p className="nugd-hero-modal-hint">
              {activeCard.id === "allotments" ? "Select round" : "Select year"}
            </p>

            <div className="nugd-hero-period-list">
                ...
                <button
                  ...
                  className={
                    ...
                    (selectedPeriod?.id === period.id
                      ? " nugd-hero-period-btn-active"
                      : "")
                  }
                  onClick={(e) => handlePeriodSelect(period, e)}
                >
                  <span className="nugd-hero-period-label">{period.label}</span>
                  <span className="nugd-hero-period-value">{period.value}</span>
                </button>
              ))}
            </div>
