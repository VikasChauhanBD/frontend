  ...
  return (
    <div className="inicet-jan26-page-root">
      ...
      <div className="inicet-jan26-content-wrapper">
        ...
        {/* ── Round pills + Columns ── */}
        <div className="inicet-jan26-round-bar">
          <div className="inicet-jan26-round-row">
            {rounds
              .filter((r) => r !== "all")
              .map((r) => (
                <button
                  ...
                  className={`inicet-jan26-round-btn ${
                    selRound === r
                      ? "inicet-jan26-round-btn-active"
                      : "inicet-jan26-round-btn-inactive"
                  }`}
                >
                  {roundLabel(r)}
                </button>
            ...
            <div className="inicet-jan26-round-actions">
              <button
        ...
        <div className="inicet-jan26-filters-section">
          ...
          {showAdv && (
            <div className="inicet-jan26-adv-filters">
              <div className="inicet-jan26-adv-filters-row">
                <CustomSelect
                  value={selCourse}
                  onChange={(v) => {
                    setSelCourse(v);
                ...
                <input
                  ...
                  className="inicet-jan26-range-input"
                />
                <input
                  type="number"
                ...
                <span className="inicet-jan26-filtered-count-inline">
