...
const InicetAllotmentsJuly2026Page = () => {
  ...
  useEffect(() => {
    fetch("/data/inicet/inicet_allotments_july_2026.csv")
      .then((r) => {
  ...
  return (
    <div className="inicet-jul26-page-root">
      ...
      <div className="inicet-jul26-content-wrapper">
        ...
        {/* ── Round pills + Columns ── */}
        <div className="inicet-jul26-round-bar">
          <div className="inicet-jul26-round-row">
            {rounds
              .filter((r) => r !== "all")
              .map((r) => (
                <button
                  ...
                  className={`inicet-jul26-round-btn ${
                    selRound === r
                      ? "inicet-jul26-round-btn-active"
                      : "inicet-jul26-round-btn-inactive"
                  }`}
                >
                  {roundLabel(r)}
                </button>
            ...
            <div className="inicet-jul26-round-actions">
              <button
        ...
        <div className="inicet-jul26-filters-section">
          ...
          {showAdv && (
            <div className="inicet-jul26-adv-filters">
              <div className="inicet-jul26-adv-filters-row">
                <CustomSelect
                  value={selCourse}
                  onChange={(v) => {
                    setSelCourse(v);
                ...
                <input
                  ...
                  className="inicet-jul26-range-input"
                />
                <input
                  type="number"
                ...
                <span className="inicet-jul26-filtered-count-inline">
